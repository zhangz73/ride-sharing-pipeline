        ...
        for random_eval_round in tqdm(range(randomized_eval_time), leave = False):
            for day in range(eval_days):
                ...
                if solver_type != "LP-AugmentedGraph" or not lp_eval_fractional_cars:
                    df_table = report_factory.get_table(markov_decision_process, action_lst, detailed = False)
                    df_table["trial"] = i
...
JSON_NAME = "100car_6region_600charger_5min_fullycharged_nyc_combo_fullday_lp-augmented" #"12car_4region_48charger_15min_fullycharged_nyc_combo_fullday_ppo" #"12car_4region_4charger_15min_fullycharged_nyc_combo_fullday_slowchargers_ppo" #"12car_4region_48charger_15min_fullycharged_nyc_combo_fullday_ppo" #"50car_5region_250charger_5min_fullycharged_nyc_combo_fullday_lp-augmented" #"12car_4region_48charger_15min_fullycharged_nyc_combo_fullday_ppo" #"100car_10region_1000charger_5min_fullycharged_nyc_combo_fullday_ppo" #"1car_2region_ppo" #"st-stc_12car4region48chargers_xi=1" #"12car_4region_2charger_15min_fullycharged_work_nyc_combo_ppo" #"1car_2region_ppo" #"100car_4region_400charger_15min_fullycharged_nyc_ppo" #"10car_5region_d-closest" #"12car_4region_48charger_15min_demandScale2_fullycharged_nyc_d-closest" #"12car_4region_2charger_15min_fullycharged_workair_nyc_ppo" #"200car_4region_nyc_ppo" #"100car_3region_ppo" # "1car_3region_patience_ppo" #"1car_3region_dp" #
